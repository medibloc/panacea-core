...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryRecordAll = (query, params = {}) => this.request({
         ...
         */
        this.queryRecord = (id, params = {}) => this.request({
         ...
         */
        this.queryWriterAll = (query, params = {}) => this.request({
         ...
         */
        this.queryWriter = (id, params = {}) => this.request({
