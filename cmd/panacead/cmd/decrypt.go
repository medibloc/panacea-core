...
func DecryptData(defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "decrypt-data [input-file-path] [output-file-path] [key-name] [dealID]",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			decryptedData, err := decrypt(clientCtx, args[2], encryptedData, oraclePubKey, nonce)
			if err != nil {
				return err
			}

			err = ioutil.WriteFile(args[1], decryptedData, 0644)
			if err != nil {
				return err
			}
