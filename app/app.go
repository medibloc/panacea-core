...
func (app *PanaceaApp) initFromGenesisState(ctx sdk.Context, genesisState GenesisState) []abci.ValidatorUpdate {
	...
	for _, ac := range genesisState.Accounts {
		fmt.Println(ac.Address.String())
	}
...
// custom logic for Panacea initialization
