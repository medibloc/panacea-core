...
var (
	pattern_Query_DID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"panacea", "did", "v2", "dids", "did_base64"}, "", runtime.AssumeColonVerbOpt(false)))
)
