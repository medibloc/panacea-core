...
var (
	...
	ErrGetDataPassRedeemReceipt   = sdkerrors.Register(ModuleName, 20, "failed get data access nft receipt.")
	ErrRedeemDataPass             = sdkerrors.Register(ModuleName, 21, "failed redeem data access nft.")
