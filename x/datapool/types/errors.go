...
var (
	...
	ErrInvalidDataCert            = sdkerrors.Register(ModuleName, 9, "certificate is not valid")
	ErrExistSameDataHash          = sdkerrors.Register(ModuleName, 10, "data already exists in the pool")
	ErrGetDataCert                = sdkerrors.Register(ModuleName, 11, "failed get data certificate.")
	...
	ErrRedeemHistoryNotFound      = sdkerrors.Register(ModuleName, 24, "redeem history not found")
)
