...
var (
	...
	pattern_Query_Contract_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"panacea", "datapool", "v2", "contract"}, "", runtime.AssumeColonVerbOpt(true)))
)
