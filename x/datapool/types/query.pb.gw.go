...
var (
	filter_Query_DataPassRedeemReceipt_0 = &utilities.DoubleArray{Encoding: map[string]int{"pool_id": 0, "round": 1, "nft_id": 2}, Base: []int{1, 1, 2, 3, 0, 0, 0}, Check: []int{0, 1, 1, 1, 2, 3, 4}}
)
...
func request_Query_DataPassRedeemReceipt_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_DataPassRedeemReceipt_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	...
	pattern_Query_DataPassRedeemReceipt_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8}, []string{"panacea", "datapool", "v2", "data_pass_redeem_receipt", "pool", "pool_id", "round", "nft", "nft_id"}, "", runtime.AssumeColonVerbOpt(true)))
