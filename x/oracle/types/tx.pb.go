...
type ApproveOracleRegistration struct {
	UniqueId               string `protobuf:"bytes,1,opt,name=unique_id,json=uniqueId,proto3" json:"unique_id,omitempty"`
	ApprovedOracleAddress  string `protobuf:"bytes,2,opt,name=approved_oracle_address,json=approvedOracleAddress,proto3" json:"approved_oracle_address,omitempty"`
...
func (m *ApproveOracleRegistration) GetApprovedOracleAddress() string {
	if m != nil {
		return m.ApprovedOracleAddress
	}
	return ""
}
...
var fileDescriptor_91b53ec53f5557f6 = []byte{
	...
	,
}
...
func (m *ApproveOracleRegistration) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ApprovedOracleAddress) > 0 {
		i -= len(m.ApprovedOracleAddress)
		copy(dAtA[i:], m.ApprovedOracleAddress)
		i = encodeVarintTx(dAtA, i, uint64(len(m.ApprovedOracleAddress)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.UniqueId) > 0 {
...
func (m *ApproveOracleRegistration) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApprovedOracleAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ApprovedOracleAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
