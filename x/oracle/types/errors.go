...
var (
	...
	ErrGetOracle                  = sdkerrors.Register(ModuleName, 3, "Error while querying oracle")
	ErrGetOracleRegistration      = sdkerrors.Register(ModuleName, 4, "Error while querying oracleRegistration")
)
