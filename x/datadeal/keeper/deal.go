...
func (k Keeper) isTrustedDataValidator(cert types.DataCert, deal types.Deal) bool {
...
func (k Keeper) VerifyDataCert(ctx sdk.Context, validatorAddr sdk.AccAddress, cert types.DataCert) (bool, error) {
